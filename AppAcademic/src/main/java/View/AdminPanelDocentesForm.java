...
public class AdminPanelDocentesForm extends javax.swing.JPanel {

 
     public AdminPanelDocentesForm(boolean is_edit) { 
        initComponents();
        initFlat(); 
         if(is_edit){
            lblTitulo.setText("Actualizar Docente");
        }else{
    ...
    private void initComponents() {
        ...
        btnGuardar.setBackground(new java.awt.Color(56, 53, 122));
        ...
        panelSolicitarLayout.setHorizontalGroup(
            ...
            .addGroup(panelSolicitarLayout.createSequentialGroup()
                ...
                .addGroup(panelSolicitarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelSolicitarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        .addGroup(panelSolicitarLayout.createSequentialGroup()
